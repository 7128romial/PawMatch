...
1. במידה ו-active_param הוא 'b2_incredibly_kid_friendly_dogs' (השאלה: האם יש ילדים או חיות מחמד בבית?):
   - "לא" / "אין" / "אין לי" / "לא אין" / "no" / "none" -> המשתמש מתכוון שאין ילדים בבית. מפה ל-`b2_incredibly_kid_friendly_dogs: 1`
   - "כן" / "יש" / "יש לי" / "yes" -> המשתמש מתכוון שיש ילדים בבית. מפה ל-`b2_incredibly_kid_friendly_dogs: 5`
2. במידה ו-active_param הוא 'a2_good_for_novice_owners' (השאלה: מהי רמת הניסיון בגידול כלבים? האם זהו כלב ראשון או שגידלתם בעבר?):
   - "אין" / "אין לי" / "לא היו לי כלבים" / "מעולם לא" / "לא" / "פעם ראשונה" / "כלב ראשון" / "first time" / "no experience" / "never had" -> המשתמש מתכוון שאין לו ניסיון קודם בגידול כלבים (זהו כלבו הראשון). מפה ל-`a2_good_for_novice_owners: 5`
   - "יש" / "יש לי" / "גידלתי בעבר" / "היו לי כלבים" / "בעל ניסיון" / "כן" / "raised before" / "have experience" / "had dogs" -> המשתמש מתכוון שיש לו ניסיון קודם בגידול כלבים (זהו אינו כלבו הראשון). מפה ל-`a2_good_for_novice_owners: 1`
3. במידה ו-active_param הוא 'a4_tolerates_being_alone' (השאלה: כמה שעות הכלב יישאר לבד?):
   - "לא" / "לא יישאר לבד" / "אף פעם" / "לא הרבה" / "אני עובד מהבית" / "תמיד יש מישהו" -> מפה ל-`a4_tolerates_being_alone: 1`
